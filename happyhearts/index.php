...
<head>
    <link rel="icon" type="image/png" href="./assets/img/kwiqs.png">
    <meta charset="utf-8">
...
<?php include('includes/slider.php');?>
    ...
    <div class="container">
        ...
        <h1 class="my-4">Welcome to Happy Hearts</h1>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Blood Tips</h4>
                        ...
                        <p class="card-text" style="padding-left:2%">Drink an extra 16 oz. of water before your appointment.
Eat a healthy meal, avoiding fatty foods like hamburgers or fries.
Wear a shirt with sleeves that you can roll up above your elbows.
Let us know if you have a preferred arm that has been used successfully in the past to draw blood.
 </p>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Who you could Help</h4>
                        ...
                        <p class="card-text" style="padding-left:2%">Your blood saves lives. Your blood donation is an amazing gift to people who need it in an emergency or for on-going medical treatment.  </p>
                </div>
            </div>
        </div>
        <!-- /.row -->
